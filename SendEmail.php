<?php
	...
	$sel1 = "select id, request, priority, issue_id, author, date from Ticket_Main Where complete=0";
...
http://quantum-co.com/Internship_Program/Edward/Project_5/Resources/BugReport.php?id=".$MainId;
	...
	//0 0 * * 1-5 /usr/bin/wget http://quantum-co.com/Internship_Program/Edward/Project_5/Resources/email.php
?>
